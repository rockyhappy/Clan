...
- **[`docs/features/DASHBOARD_AND_NAVIGATION.md`](file:///E:/Nodejs%20Projects/Clan/docs/features/DASHBOARD_AND_NAVIGATION.md)**: Main hub layout, bottom navigation structure, and screen routing.
